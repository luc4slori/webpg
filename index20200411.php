 ...
 ?>
        ...
        <div class="container-ppal" id="tabppal">
            <div class="row hide-on-large">
                <div class="col s12 m12 l12 " style="margin-top:18px">
					<div class="containerimg">
							...
							<div class="content">
                                  <h4>VIEJOS SON LOS TRAPOS</h2>
                                  
                                  <p class="p1"><br />Las últimas noticias para nuestros<br />Jubilados y Pensionados</p>
									<a class="ghost-button" href="<?php echo($rootDir.'/nuevo/2020-viejosSonLosTrapos')?>">CLICK AQUI</a>
							   </div>
							...
							echo('<div class="row loultimo" id="loultimo-'.$nota["id"].'" style="padding-top: 0px;">');
								...
								<div class="col s12 m12 center ">');
									if ($nota["filenameFoto"]){
										echo('<img src="'.$rootDir.'/'.$nota["pathFoto"].'/'.$nota["id"].'/'.$nota["filenameFoto"].'" alt="" class="circle responsive-img center" style="max-height=400px">');
									} else {
										echo('<img src="'.$rootDir.'/'.$nota["pathFoto"].'/'.$nota["id"].'" alt="" class="circle responsive-img center hidden" style="max-height=400px">');
									}
						...
						foreach($notasOld as $nota){
							echo('<div class="col s12 m12 l6">
								<div class="row oldnotas" style="box-shadow: 0 27px 24px 0 rgba(0, 0, 0, 0.2), 0 40px 77px 0 rgba(0, 0, 0, 0.22);background-color: #C6D8E7;padding-top: 4px; margin-top:20px;">');
									...
									<div class="col s12 m12 center ">');
										if($nota["filenameFoto"]){
											echo('<img src="'.$rootDir.'/'.$nota["pathFoto"].'/'.$nota["id"].'/'.$nota["filenameFoto"].'" alt="" class="circle responsive-img center" style="max-height=400px; box-shadow: 0 27px 24px 0 rgba(0, 0, 0, 0.2), 0 40px 77px 0 rgba(0, 0, 0, 0.22);">');
										}else{
											echo('<img src="'.$rootDir.'/'.$nota["pathFoto"].'/'.$nota["id"].'" alt="" class="circle responsive-img center hidden" style="max-height=400px">');
										}
						...
						<div class="row hide-on-med-and-down" id="menu'.$menu["id"].'-publiv2" style="margin-bottom:0px">');
							...
							foreach ($publisV2 as $publi){
								...
								<div class="col s6" style="box-shadow: rgba(0, 0, 0, 0.2) 0px 27px 24px 0px, rgba(0, 0, 0, 0.219608) 0px 40px 77px 0px; padding-top: 4px; margin-top: 20px; cursor: pointer; ">
									<div class="vergini" onmousedown="window.location.href= '."'".$publi["href"]."'".' ">	
							...
							foreach ($publisMedio as $publi){
								echo('<div class="row hide-on-med-and-up row-publi">
									<div class="col s12 m12">																							
										<a href="'.$rootDir.'/'.$publi["href"].'" class="radio-online"><object data="'.$rootDir.'/'.$publi["pathFoto"].'/'.$publi["id"].'/'.$publi["filenameFoto"].'" style="width:100%" alt="" class="responsive-img"></object></a>
									</div>						
								</div>');
							}
						echo('</div>');
	...
	<script type="text/javascript" src="<?=$rootDir.'/js/jquery-2.1.3.min.js'?>"></script>
	 <!-- <script type="text/javascript" src="js/prism.js"></script> -->
	  ...
	  <script type="text/javascript" src="<?=$rootDir.'/js/lunr.min.js'?>"></script>	  
	  <script type="text/javascript" src="<?=$rootDir.'/js/search.js'?>"></script> 
	  
	  
	  <script type="text/javascript" src="<?=$rootDir.'/js/materialize.js'?>"></script> 
	
	 <script src="<?=$rootDir.'/js/handlebars-v3.0.3.js'?>"></script>
	 
	
	 <script src="<?=$rootDir.'/js/index-fill.js'?>"></script>
